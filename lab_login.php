...
body{background-color:#3399FF}</style>
               <font  size="5"><form name="f1"action="lab_login.php"method="post">
               <br>
<table width="612"  align="center">
			    <tr>
    <td width="90"><h4>E-mail</h4></td>
...
<a href=lab_reg.php>Lab attendent signup</a>
</form>
<?php
session_start();
if(isset($_POST['b1']))
