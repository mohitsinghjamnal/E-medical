...
body{background-color:#3399FF}</style></head><p>
               <form name="f1" action="adddoctor.php" method="post">
<font size="6">Doctor name&nbsp;</font><input type="text" name="t1"><br><br>
...
if($con==true)
{
$cmd="select * from dictor_info where dname='$n'";
if($r=$con->query($cmd))
{
if($rw=$r->fetch_array())
{
echo"name is  ".$rw[0]."<br>";
echo"department is  ".$rw[1]."<br>";  
echo"hospital  name is  ".$rw[2]."<br>";
echo"specialisation is  ".$rw[3]."<br>";
}
else
{
echo"no such doctor found";
}
}
else
{
...
if(isset($_POST['b2']))
{
header('location:doctorinsert.php');
}
?>
