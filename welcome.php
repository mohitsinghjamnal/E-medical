...
body{background-color:#3399FF}</style></head><p>
              <?php
session_start();
echo"<font size=6>welcome Admin   ".$_SESSION['u']."<br></font>";
echo"<font size=4><a href=addhospital.php>ADD HOSPITAL</a></font><br>";
echo"<font size=4><a href=adddoctor.php>ADD DOCTOR</a></font><br>";
echo"<font size=4><a href=medicalcamps.php>MEDICAL CAMPS</a></font><br>";
echo"<font size=4><a href=addlabtechnician.php>ADD LAB TECHNICIAN</a></font><br>";
echo"<font size=5><a href=logout.php><u>Signout</u></a>";
?>
