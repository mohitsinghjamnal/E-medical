...
<input type="submit" value="Insert" name="b2"><br>
</form>
<?php
if(isset($_POST['b1']))
{
...
if($con==true)
{
$cmd="select * from hospital_info where hospital_name='$n'";
if($r=$con->query($cmd))
{
if($rw=$r->fetch_array())
{
echo"hospital name is  ".$rw[0]."<br>";
echo"contact number is  ".$rw[1]."<br>";  
echo"address is  ".$rw[2]."<br>";
echo"email id is  ".$rw[3]."<br>";
}
else
{
