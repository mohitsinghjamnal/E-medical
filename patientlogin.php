	...
	<body>
		...
		<div class="clear"> </div>
		   ...
		   <div class="section group">
			  ...
			  <head>
<style type="text/css">
body{background-color:#3399FF}</style></head><br><p>
<font  size="5"><form name="f1" action="patientlogin.php" method="post"><pre>
Username  <input type="text" name="t1">
password   <input type="password" name="t2"><br></pre>
<table> 
<tr>
...
<a href="patientreg.php">New user click here</a><br>
</form>
<?php
session_start();
if(isset($_POST['b1']))
