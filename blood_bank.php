...
<br><p><img src="images/2000.png"><pre>                                 Give Blood 
                                                    Give Life ...</pre></p><br><br>
               <form name="f1" action="blood_bank.php" method="post">
<input type="submit" name="b1" value="View Blood Request's">
<input type="submit" name="b2" value="View Blood Donation's">
</form>
<br>
<?php
if(isset($_POST['b1']))
...
echo"Gender is :-".$rw[1]."<br>";
echo"Contact_number is :-".$rw[2]."<br>";
echo"Address is :-".$rw[3]."<br>";
echo"Blood_group :-".$rw[4]."<br>";
echo"Age :-".$rw[5]."<br><hr color=black>";
}
}
else
{
...
if($con==true)
{
$cmd="select * from blood_donation";
...
echo"Contact_number is :-".$rw[2]."<br>";
echo"Address is :-".$rw[3]."<br>";
echo"Email_id is :-".$rw[4]."<br>";
echo"Blood_group :-".$rw[5]."<br>";
echo"Age :-".$rw[6]."<br>";
echo"Last_donation :-".$rw[7]."<br>";
echo"Medical_history :-".$rw[8]."<br><hr color=black>";
}
}
else
{
		   ...
		   <div class="footer">
		   	 <div class="wrap">
   			  ...
   			  <ul>
						...
						<li><a href="about.php">About</a></li>
						<li><a href="services.phpl">services</a></li>
						<li><a href="blog.php">blog</a></li>
						<li><a href="contact.php">contact</a></li>
