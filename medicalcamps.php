...
<form name="f1" action="medicalcamps.php" method="post">
Hospital name<input type="text" name="t1"><br>
<input type="submit" value="Details" name="b1">
<a href="campsubmit.php"><input type="submit" value="Insert" name="b2"></a>
</font>
</p>
</head>
</form>
...
if($con==true)
{
$cmd="select * from medical_camps where hospital='$e'";
if($r=$con->query($cmd))
{
if($rw=$r->fetch_array())
{
echo"date is  ".$rw[0]."<br>";
echo"time is  ".$rw[1]."<br>";  
echo"venue is  ".$rw[2]."<br>";
echo"hospital  name is  ".$rw[3]."<br>";
echo"doctor name is  ".$rw[4]."<br>";
echo"facility is  ".$rw[5]."<br>";
}
else
{
...
if(isset($_POST['b2']))
{
header('location:campsubmit.php');
}
?>
</body>
</html>
