...
<head>
<style type="text/css">
body{background-color:#3391E7}</style></head><p><font size="6" color="black">
<form name="f1" action="campsubmit.php" method="post"><pre>
Date               :<input type="text" name="t1"> 
Time              :<input type="text" name="t2">
Venue            :<input type="text" name="t3"> 
Hospital         :<input type="text" name="t4">
Doctor name  :<input type="text" name="t5">
Facility           :<input type="text" name="t6"></pre>
<table>
 <tr>
