...
<head>
<style type="text/css">
body{background-color:blue}</style></head><p><font face="comic sans ms" size="18" color="yellow">
<form name="f1" action="addlabtechnician.php" method="post">
name<input type="text" name="t1"><br> 
hospital name<input type="text" name="t2"><br>
department<input type="text" name="t3"><br> 
...
{
echo"hospital name should be numeric<br>";
}
}
else
{
...
if($t==0)
{
$cmd="insert into labtechnician values('$n','$c','$a')";  
