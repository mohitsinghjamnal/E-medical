...
<form name="f1" action="campsubmit.php" method="post">
date<input type="text" name="t1"><br> 
time<input type="text" name="t2"><br>
venue<input type="text" name="t3"><br> 
hospital<input type="text" name="t4"><br>
doctor name<input type="text" name="t5"><br>
facility<input type="text" name="t6"><br>
...
{
echo"date should be numeric<br>";
}
}
else
{
echo"date should not be empty<br>";
}
if(!empty($_POST['t2']))
{
...
{
echo"time should be numeric<br>";
}
}
else
{
echo"time should not be empty<br>";
}
if(!empty($_POST['t3']))
{
...
{
echo"venue should contain only alphabets<br>";
}
}
else
{
echo"venue should not be empty<br>";
}
if(!empty($_POST['t4']))
{
...
{
echo"doctors name should contain only alphabets<br>";
}
}
else
{
echo"doctor's name should not be empty<br>";
}
if(!empty($_POST['t6']))
{
if(ctype_alpha($_POST['t6']))
{
$t=0;
$w=$_POST['t6'];
}
...
{
echo"facilities should contain only alphabets<br>";
}
}
else
{
echo"facilities should not be empty<br>";
}
...
if($t==0)
{
$cmd="insert into medical_camps values('$n','$c','$a','$e','$q','$w')";  
