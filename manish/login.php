	...
	<body>
		...
		<div class="clear"> </div>
		   ...
		   <div class="section group">
			  ...
			  <head>
<style type="text/css">
body{background-color:#3399FF}</style></head><p><font face="comic sans ms" size="18" color=#FFFFFF>
               <form name="f1" action="login.php" method="post">
			     <table width="612"  align="center">
			    <tr>
    <td width="90">username</td>
    <td width="189"><input type="text" name="t1"></td>
    <td width="317" rowspan="3"></td>
  </tr>
  <tr>
    <td>password</td>
  ...
  <tr>
    <td colspan="2"><div align="center">
      <input name="b1" type="submit" class="frist" value="login">
    </div></td>
    </tr>
</table>
			     <br>
...
if($con==true)
{
$cmd="select * from admin_login where uname='$u' and password='$p'";
if($r=$con->query($cmd))
{
if($r->num_rows>0)
{
