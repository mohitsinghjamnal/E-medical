...
<?php
$r=$_GET['d'];
echo"<u><font size=6>INTRODUCTION</font></u><br><br>";
$con=new mysqli("localhost","root","","emedical");
if($con==true)
{
$cmd="select * from specialities where DISEASE='$r'";
if($r=$con->query($cmd))
{
if($r->num_rows>0)
{
...
{
echo"<td align=center><font size=5>$rw[0]</font><br>";
echo"<td align=center>$rw[1]";  
}
}
else
{
