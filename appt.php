...
<form name="f1" action="appt.php" method="post">
enter patient name<input type="text" name="t1">
...
if($con==true)
{
$cmd="select * from  accept_appointments where patient_name='$p'";
...
{
echo"<font size=5>Appointment accepted</font><br><br>";	
echo"patient_name :" .$rw[0]."<br>";
echo"doctor_name :".$rw[1]."<br>";
echo"date :".$rw[2]."<br>";
echo"time :".$rw[3]."<br><hr color=black>";
}
}
else
{
echo"reject appointment";
}}
else
{
echo "Query Problem";
