...
<table style="border-style:groove" width=800>
<tr>
<th>
<b><font size=5>Date</b>
</th>
<th>
<b><font size=5>Time</b>
</th>
<th>
<b><font size=5>Venue</b>
</th>
<th>
<b><font size=5>HospitalName</b>
</th>
<th>
<b><font size=5>DoctorName</b>
</th>

<th>
<b><font size=5>Facility</b>
</th>
</tr>
<tr>
          <?php

echo"<u><font size=6>Camp details</font></u><br><br>";
$con=new mysqli("localhost","root","","emedical");
if($con==true)
{
$cmd="select * from medical_camps";
if($r=$con->query($cmd))
{
if($r->num_rows>0)
{
...
{
echo"<td align=center>$rw[0]</td>";
echo"<td align=center>$rw[1]</td>";  
echo"<td align=center>$rw[2]</td>";
echo"<td align=center>$rw[3]</td>";
echo"<td align=center>$rw[4]</td>";
echo"<td align=center>$rw[5]</td></tr>";

}
}
else
{
echo"no medical camp available";
}
}
else
{
