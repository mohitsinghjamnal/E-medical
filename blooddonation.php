...
body{background-color:#3399FF}</style>
               <font  size="5"><form action="blooddonation.php"method="post"name="f1"><br><pre>
Name               <input type="text"name="t1" /><br/>
Gender             <input name="r2"type="radio"value="male" />male<input name="r2"type="radio"value="female" />female<br />
Contact_no      <input type="text"name="t3" /><br />
Address            <input type="text"name="t4" /><br />
Email_id           <input type="text"name="t5" /><br />
Blood_group     <input type="text"name="t6" /><br />
Age                   <input type="text"name="t7" /><br />
Last_donation   <input type="text"name="t8" /><br />
Medical_history<input type="text"name="t9" /><br /></pre><br>
  <table>
  <tr>
    <td colspan="1"><div align="center">
      <input name="b1" type="submit" class="frist" value="submit" style="width:100px">
    </div></td>
    </tr>
</table></font></form>
<?php
if(isset($_POST['b1']))
{
	...
	$con=new mysqli("localhost","root","","emedical");
		if($con==true)
{
	$cmd="insert into blood_donation values ('$n','$g','$cn','$ad','$ei','$bg','$ag','$ld','$mh')";
