...
session_start();
$u=$_SESSION['u'];
echo "<font size=5>Welcome user   ".$u."</font>";
echo "<br>";
?>
<form name="f1" action="patient_home.php"  method="POST">
<welcome user<input type="text" name="t1"><br>
<input type="submit" name="b1"value="Profile_Info">
<input type="submit" name="b2" value="View_Hospitals">
<input type="submit" name="b3" value="Take_Appointment">
</form>
<?php
if(isset($_POST['b3']))
{
...
Patient name&nbsp;&nbsp;<input type=text name=t1 value=$rw[0]><br>
Username&nbsp;&nbsp;<input type=text name=t2 value=$rw[1]><br>
Contactnumber<input type=text name=t3 value=$rw[2]><br>
Address&nbsp;&nbsp;<input type=text name=t4 value=$rw[3]><br>
E_mailid<input type=text name=t5 value=$rw[4]><br>
Password&nbsp;<input type=PASSWORD name=t6 value=$rw[5]><br>
<input type=submit name=b9 value=update>
</form>";
}
}
else
...
if($con==true)
{
$cmd="update  patientinfo set patient_name='$a',contact_number='$c',address='$d',email_id='$e',password='$f' where  user_name='$b'";
...
while($rw=$r->fetch_array())
{
echo"<br>hospital_name : " .$rw[0]."<br>";
echo"contact_number :".$rw[1]."<br>";
echo"address :".$rw[2]."<br>";
echo"email_id :".$rw[3]."<br><hr color=black>";
}
}
else
{
